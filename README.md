...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create budget-management-2982
  fly apps create budget-management-2982-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app budget-management-2982
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app budget-management-2982-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'budget-management-2982-staging' does not match app name in config file 'budget-management-2982'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name budget-management-2982-db
  fly postgres attach --app budget-management-2982 budget-management-2982-db

  fly postgres create --name budget-management-2982-staging-db
  fly postgres attach --app budget-management-2982-staging budget-management-2982-staging-db
  ```
